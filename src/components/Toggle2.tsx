    ...
    <>
      <div>
            ...
            <div className="bg-[#F2F5F9] h-[auto] pt-[32px] pb-[48px] pl-[28px] pr-[28px]">
                    ...
                    <h1 onClick={()=> appear2(toggleNum2)} className="text-[#495567] text-[18px] font-bold leading-[24px] cursor-pointer w-[300px]">{title}</h1>
                        <img onClick={()=> appear2(toggleNum2)} style={{rotate: itemNum2 === toggleNum2 ?'180deg':'', transition:'1s', cursor:'pointer'}} src={img} alt="Arrow" />
                    </div>

                    { itemNum2 === toggleNum2 ? <p className="text-[#495567] leading-[25px] w-[280px] change">
                        {paragraph}
                        </p>: null}
            </div>
     </div>
